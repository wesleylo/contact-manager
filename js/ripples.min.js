...
d) {
    ...
    e.prototype.init=function() {
        ...
        c.on("mousedown touchstart", function(d) {
            if(!g.isTouch()||"mousedown"!==d.type) {
                ...
                var e=c.children(".ripple-container"), f=g.getRelY(e, d), h=g.getRelX(e, d);
                if(f||h) {
    ...
    ,
    e.prototype.rippleOn=function(a,
    b) {
        ...
        ).addClass("ripple-on").data("animating",
        "on").data("mousedown",
        "on"):b.animate( {
